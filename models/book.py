...
class Book(db.Model):
    ...
    ISBN = db.Column(db.String(100), db.ForeignKey('booktable.ISBN', onupdate='CASCADE', ondelete='CASCADE'), nullable=False)
    location = db.Column(db.String(20), nullable=False, default='图书阅览室')
    manager_id = db.Column(db.Integer, db.ForeignKey('manager.id', onupdate='CASCADE', ondelete='CASCADE'), nullable=False)
